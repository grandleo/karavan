    ...
    return (
        <>
            ...
            <Flex justify="space-between" align="center">
                <Text className={classes.orderDetailClientId}>ID: {orderDetails.supplier_id} - {orderDetails.supplier_name}</Text>
                <Text className={classes.orderDetailNumberId}>№ {orderDetails.id}</Text>
            </Flex>
            <Flex justify="space-between" align="center">
                <Flex align="center">
                    <Text className={classes.orderDetailClientName}>{orderDetails.client_id} - {orderDetails.client_name}</Text>
                    ...
                    <Table.Tr>
                        ...
                        <Table.Td>
                            <NumberFormatter
                                prefix={orderDetails.currency.prefix ? orderDetails.currency.prefix : ''}
                                suffix={orderDetails.currency.suffix ? orderDetails.currency.suffix : ''}
                                value={orderDetails.total_percent_sum}
                                thousandSeparator=" "
                            />
                        </Table.Td>
                        <Table.Td>
